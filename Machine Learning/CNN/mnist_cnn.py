...
Original file is located at
    https://colab.research.google.com/drive/18L_nQzydxV8hcOmYYzI4ApDp7weVF5tQ
"""
...
print(*ep_loss_train, sep = "\n")

print(*ep_loss_test, sep = "\n")

print(*ep_acc_train, sep = "\n")

print(*ep_acc_test, sep = "\n")
